    ...
    const FString& RuntimeErrorContext)
{
    ...
    return FString::Printf(
        ...
        TEXT("- Never instantiate unreal.VFXAgentPythonBridge(); call classmethods directly\\n")
        ...
        TEXT("Template fallback note: prefer /Niagara/DefaultAssets/Templates/Systems/NS_Fountain.NS_Fountain; avoid /Niagara/DefaultAssets/Templates/SystemTemplate.SystemTemplate.\\n")
        TEXT("Before any get_path_name() call, object must be non-None, or use safe_get_path_name(obj).\\n")
