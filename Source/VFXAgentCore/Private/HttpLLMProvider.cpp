...
FString UHttpLLMProvider::BuildSystemPrompt() const
{
	...
	return FString(TEXT(
		...
		"   - Else: duplicate a non-empty Niagara system template (prefer /Niagara/DefaultAssets/Templates/Systems/NS_Fountain.NS_Fountain).\n"
		"   - Do NOT use /Niagara/DefaultAssets/Templates/SystemTemplate.SystemTemplate (often missing).\n"
