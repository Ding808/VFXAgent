...
FString UHttpLLMProvider::BuildSystemPrompt() const
{
	...
	return FString(TEXT(
		...
		"- create_system(target_path, system_name)  -> returns system_object_path\n"
		"- add_emitter_from_template(TARGET_SYSTEM, template_asset_path, emitter_name)\n"
		"    NOTE: add_emitter_from_template takes the live UNiagaraSystem object (TARGET_SYSTEM),\n"
		"          NOT a string path. Do NOT pass system_object_path here.\n"
		...
		"  vfx_agent.bridge.add_emitter_from_template(TARGET_SYSTEM,\n"
