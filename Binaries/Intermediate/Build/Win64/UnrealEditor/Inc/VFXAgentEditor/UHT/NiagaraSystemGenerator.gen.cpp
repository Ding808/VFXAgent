...
#include "VFXAgentEditor/Public/NiagaraSystemGenerator.h"
...
VFXAGENTEDITOR_API UClass* Z_Construct_UClass_UNiagaraSystemGenerator();
VFXAGENTEDITOR_API UClass* Z_Construct_UClass_UNiagaraSystemGenerator_NoRegister();
...
template<> VFXAGENTEDITOR_API UClass* StaticClass<UNiagaraSystemGenerator>()
{
	return UNiagaraSystemGenerator::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_VFXAgent_Source_VFXAgentEditor_Public_NiagaraSystemGenerator_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemGenerator, UNiagaraSystemGenerator::StaticClass, TEXT("UNiagaraSystemGenerator"), &Z_Registration_Info_UClass_UNiagaraSystemGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemGenerator), 2503815263U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_VFXAgent_Source_VFXAgentEditor_Public_NiagaraSystemGenerator_h_2097372382(TEXT("/Script/VFXAgentEditor"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_VFXAgent_Source_VFXAgentEditor_Public_NiagaraSystemGenerator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_VFXAgent_Source_VFXAgentEditor_Public_NiagaraSystemGenerator_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
